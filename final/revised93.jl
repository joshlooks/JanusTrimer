...
const maxevals1 = 5000000
const atol1 = 1e-8

const potential_coefficient = 3 * 3^0.5 / 2 * ε
...
for task_index in tasks
    ...
    s = string(round(theta1 * 180/π), ",", round((π - theta2) * 180/π), ",", c1, ",", c2, ",", c3, ",", c4, ",", c5, ",", c6, ",", c7, ",", c8, ",", c9, ",", c10, ",", et, "\n")
    global output = string(output, s)
end

file = string("/nesi/nobackup/uoa00623/Jack/vary_patch_93/J", angle_chooser + 1, "0_P", 2 * phi_chooser, "0.csv")
