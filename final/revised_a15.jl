...
const ab = 0.15 # Hydrophillic - Hydrophobic
const bb = 0.0225 # Hydrophobic - Hydrophobic
const aw = 1.00 # Hydrophillic - Solvent
const bw = 0.15 # Hydrophobic - Solvent
...
file = string("/nesi/nobackup/uoa00623/Jack/vary_patch_A15/J", angle_chooser + 1, "0_P", 2 * phi_chooser, "0.csv")
