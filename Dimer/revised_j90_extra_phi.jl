...
angle_chooser = 8
phi_chooser = array_index

global partition_angle = (angle_chooser/18 + 1/18) * π
global phi = (phi_chooser / 18) * π
...
file = string("/nesi/nobackup/uoa00623/Jack/vary_patch_J90_extra_phi/J", angle_chooser + 1, "0_P", phi_chooser, "0.csv")
